  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl text-center z-10 space-y-6">
        ...
        <div className="inline-flex items-center gap-2 bg-slate-900 border border-slate-800 px-4 py-1.5 rounded-full text-sm font-medium text-emerald-400">
        ...
        <div className="flex flex-wrap justify-center gap-2 pt-2 text-xs font-mono text-slate-500">
