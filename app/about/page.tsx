      ...
      <div className="max-w-3xl mx-auto space-y-12 z-10 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-xl space-y-1">
            ...
            <div className="text-sm font-semibold text-slate-100">1st Place</div>
            <div className="text-xs text-slate-500 leading-relaxed">West Java Health Tech Innovation Competition 2025</div>
          </div>
          <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-xl space-y-1">
            <div className="text-2xl">📄</div>
            <div className="text-sm font-semibold text-slate-100">Published Research</div>
            <div className="text-xs text-slate-500 leading-relaxed">Presented at ISPACS 2025 international symposium</div>
          </div>
          <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-xl space-y-1">
            <div className="text-2xl">🎓</div>
            <div className="text-sm font-semibold text-slate-100">Biomedical Eng.</div>
            <div className="text-xs text-slate-500 leading-relaxed">Institut Teknologi Bandung (ITB)</div>
          </div>
        </div>

        {/* Philosophy */}
        <div className="border-l-2 border-blue-500 pl-4 space-y-2">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Solution Philosophy</h3>
        ...
        <div className="bg-slate-900/30 border border-slate-900 p-6 rounded-xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs text-slate-500">Let&apos;s schedule a short, free consultation.</p>
          </div>
